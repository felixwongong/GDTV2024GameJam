...
namespace CofyEngine.Editor
{
    ...
    public class CofyDirectoryNameAttributeDrawer : PropertyDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            folderButton.style.backgroundImage =
                new StyleBackground((Texture2D)EditorGUIUtility.IconContent("d_Collab.FolderMoved").image);
            ...
            else
            {
                ...
                {
                    DirectoryTools.FocusDirectory(property.stringValue);
                };
            }
